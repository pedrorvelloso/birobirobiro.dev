...
*[View source code →](https://github.com/zenorocha/birobirobiro.dev/tree/v1)*

<img alt="birobirobiro.dev V1 screenshot" src="/static/img/posts/how-i-built-my-personal-website-2012.jpg" class="post-image-full">

## Version 2 (2013 - 2015)

Apart from this site, I also had a blog that was hosted on [Tumblr](https://www.tumblr.com/) and that was served with the `blog.birobirobiro.dev` domain.
...
*[View source code →](https://github.com/zenorocha/birobirobiro.dev/tree/v2)*

<img alt="birobirobiro.dev V2 screenshot" src="/static/img/posts/how-i-built-my-personal-website-2013.jpg" class="post-image-full">
...
*[View source code →](https://github.com/zenorocha/birobirobiro.dev/tree/v3)*

<img alt="birobirobiro.dev V3 screenshot" src="/static/img/posts/how-i-built-my-personal-website-2016.jpg" class="post-image-full">
...
*[View source code →](https://github.com/zenorocha/birobirobiro.dev/tree/master)*

<img alt="birobirobiro.dev V4 screenshot" src="/static/img/posts/how-i-built-my-personal-website-2021.jpg" class="post-image-full" style="border: 1px solid rgba(255, 255, 255, .3)">
